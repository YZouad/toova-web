...
seed(cat_slug, prod_slug, name, description, affiliate_url, price_cents, sort_order, place_builtin) AS (
  VALUES
    ...
    ('storage', 'storage-1', 'Under-bed storage bins', 'Shallow bins that slide under a twin bed.', 'https://amzn.to/4yGnG0P', 2999, 10, 'dresser'),
    ('storage', 'storage-2', 'Cube storage unit', 'Open cubes for crates and baskets.', 'https://amzn.to/4vRbYhp', 3999, 20, 'dresser'),
